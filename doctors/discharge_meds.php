 ...
 if ($age<1) {
  echo $age*12; echo "&nbsp;"."Months";
   ...
   <form action="savenew_inp.php" method="POST">
     <span><input type="text" size="25" value="" name="drug" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="search drug" style="width: 40%; height:30px;" required/>&nbsp;<input type="text" name="strength" placeholder="enter strength" required><select name="roa" placeholder="ROA"><option value="1">P.O</option><option value="2">IV</option><option value="3">IM</option><option value="4">SC</option><option value="5">topical</option></select><select name="freq" required/><option disabled>frequency</option><option value="0">stat</option><option value="1">od</option><option value="2">bd</option><option value="3">tds</option><option value="4">qid</option><option value="5">q5h</option><option value="6">q6h</option></select>&nbsp;<input type="number" name="duration" placeholder="enter duration" required>
...
?></td> </td>
   ...
   <p>&nbsp;</p>
   <a href="discharge.php?search= &response=1"><button class="btn btn-success" style="width: 70%;">save</button></a>
