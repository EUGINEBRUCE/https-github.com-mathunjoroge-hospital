                ...
                if (h) {
                    ...
                    if (!d || d.hasError || d.url.toLowerCase() != h.toLowerCase()) {
                        ...
                        var s = (new Date).getTime(),
                            ...
                            m = function() {
                                var b = "undefined";
                                if (OSF._OfficeAppFactory.getHostInfo().hostType == "onenote" && typeof OSF.AppTelemetry !== b && typeof OSF.AppTelemetry.enableTelemetry !== b) OSF.AppTelemetry.enableTelemetry = a;
                                if (!OSF._OfficeAppFactory.getLoggingAllowed() && typeof OSF.AppTelemetry !== b) OSF.AppTelemetry.enableTelemetry = a;
                                o(c);
                                d.isReady = c;
                                if (d.timer != e) {
        ...
        (function(d) {
            function e() {
                return function() {
                    ...
                    var Y = typeof window !== b ? window : undefined,
                        D = Y || {},
                        A = D.MutationObserver || D.WebKitMutationObserver,
                        nb = typeof process !== b && {}.toString.call(process) === "[object process]",
                        lb = typeof Uint8ClampedArray !== b && typeof importScripts !== b && typeof MessageChannel !== b;
                    ...
                    function eb(b) {
                        ...
                        for (var c = 0; a._state === k && c < h; c++) u(d.resolve(b[c]), undefined, e, g);
                        return a
                    }
                    var V = eb;
...
OSF._OfficeAppFactory = function() {
    ...
    n("Microsoft", window);
    n("Office", Microsoft);
    n("WebExtension", Microsoft.Office);
    if (window.Office.Promise) Microsoft.Office.WebExtension.Promise = window.Office.Promise;
    ...
    var q = {},
        ...
        t = d,
        m = [],
        g = new ScriptLoading.LoadScriptHelper;
    window.performance && window.performance.now && g.logScriptLoading(OSF.ConstantNames.OfficeJsId, -1, window.performance.now());
    var y = window.location.hash,
        x = window.location.search,
        v = window.name,
        s = function(a) {
            return {
                host: OfficeExt.HostName.Host.getInstance().getHost(a),
                platform: OfficeExt.HostName.Host.getInstance().getPlatform(a)
            }
        },
        r = function(a) {
            var d = a.host,
    ...
    Microsoft.Office.WebExtension.onReady = function(a) {
        if (t) {
            ...
            if (a) {
                ...
                if (b && b.then && typeof b.then === h) return b.then(function() {
        ...
        if (a) return new Office.Promise(function(b) {
            m.push(function(d) {
                var c = a(d);
                if (c && c.then && typeof c.then === h) return c.then(function() {
                    return b(d)
                });
                b(d)
            })
    ...
    var o = function(g) {
        ...
        C = function(f, g) {
            var c = f.split("."),
                ...
                a;
            for (a in c)
                if (parseInt(c[a]) < parseInt(e[a])) return d;
                else if (parseInt(c[a]) > parseInt(e[a])) return b;
            return d
        },
        A = function() {
            var b = "15.30.1128.0",
        ...
        w = function() {
            ...
            try {
                ...
                if (typeof window.external.GetLoggingAllowed === c) k = b;
                else k = window.external.GetLoggingAllowed()
            } catch (e) {}
        },
        B = function() {
            var i = "hostInfoValue",
            ...
            if (!h) try {
                window.external = window.external || {};
                if (typeof agaveHost !== c && agaveHost.GetHostInfo) window.external.GetHostInfo = function() {
                ...
                if (k == m) {
                    a.isO15 = b;
                    a.isDialog = b
                } else if (k.toLowerCase().indexOf("mac") !== -1 && k.toLowerCase().indexOf("outlook") !== -1 && A()) a.isO15 = b;
                else {
                    var q = k.split(p + "=");
                    if (q.length > 1) h = q[1];
                    else h = k
            ...
            if (h) {
                ...
                a.isO15 = d;
                var g = h.split("$");
                if (typeof g[2] == c) g = h.split("|");
                a.hostType = typeof g[0] == c ? f : g[0].toLowerCase();
                a.hostPlatform = typeof g[1] == c ? f : g[1].toLowerCase();
                a.hostSpecificFileVersion = typeof g[2] == c ? f : g[2].toLowerCase();
                a.hostLocale = typeof g[3] == c ? f : g[3].toLowerCase();
                a.osfControlAppCorrelationId = typeof g[4] == c ? f : g[4];
                if (a.osfControlAppCorrelationId == "telemetry") a.osfControlAppCorrelationId = f;
                a.isDialog = typeof g[5] != c && g[5] == m ? b : d;
                a.disableLogging = typeof g[6] != c && g[6] == "disableLogging" ? b : d;
                var t = parseFloat(a.hostSpecificFileVersion),
                    n = OSF.HostSpecificFileVersionDefault;
                if (OSF.HostSpecificFileVersionMap[a.hostType] && OSF.HostSpecificFileVersionMap[a.hostType][a.hostPlatform]) n = OSF.HostSpecificFileVersionMap[a.hostType][a.hostPlatform];
                if (t > parseFloat(n)) a.hostSpecificFileVersion = n;
                if (j) try {
                    j.setItem(i, h)
                } catch (w) {}
            } else {
                a.isO15 = b;
                a.hostLocale = o("locale")
            }
        },
        z = function(b, a) {
        ...
        D = function() {
            B();
            w();
            if (a.hostPlatform == "web" && a.isDialog && window == window.top && window.opener == e) {
                window.open(f, "_self", f);
                window.close()
            }
            g.setAppCorrelationId(a.osfControlAppCorrelationId);
            var k = g.getOfficeJsBasePath(),
                C = d;
            ...
            var m = function() {
                    if (typeof Sys !== c && typeof Type !== c && Sys.StringBuilder && typeof Sys.StringBuilder === h && Type.registerNamespace && typeof Type.registerNamespace === h && Type.registerClass && typeof Type.registerClass === h || typeof OfficeExt !== c && OfficeExt.MsAjaxError) return b;
                    else return d
                },
                n = e,
                x = function(f) {
                    var a = d,
                        e = function() {
                            if (typeof Strings == c || typeof Strings.OfficeOM == c)
                                if (!a) {
                                    a = b;
                                    var h = k + OSF.ConstantNames.DefaultLocale + "/" + OSF.ConstantNames.OfficeStringJS;
                                    g.loadScript(h, OSF.ConstantNames.OfficeStringsId, e, b, OSF.ConstantNames.LocaleStringLoadingTimeout);
                                    return d
                    ...
                    var h = k + OSF.getSupportedLocale(f, OSF.ConstantNames.DefaultLocale) + "/" + OSF.ConstantNames.OfficeStringJS;
                    g.loadScript(h, OSF.ConstantNames.OfficeStringsId, e, b, OSF.ConstantNames.LocaleStringLoadingTimeout)
                },
                t = function(t) {
                    if (t) {
                        i = new OSF.InitializationHelper(a, j, q, E, p);
                        a.hostPlatform == "web" && i.saveAndSetDialogInfo && i.saveAndSetDialogInfo(o(l));
                        ...
                        z(j.wnd, function(b) {
                            ...
                            u = b._appInstanceId;
                            var c = function() {
                                var c = a.hostSpecificFileVersion.split(".");
                                if (b.get_appMinorVersion) {
                                    var d = a.hostPlatform == "ios";
                                    if (!d)
                                        if (isNaN(b.get_appMinorVersion())) b._appMinorVersion = parseInt(c[1]);
                                        else if (c.length > 1 && !isNaN(Number(c[1]))) b._appMinorVersion = parseInt(c[1])
                                }
                                if (a.isDialog) b._isDialog = a.isDialog
                            };
                            c();
                            var d = function() {
                                i.prepareApiSurface && i.prepareApiSurface(b);
                                g.waitForFunction(function() {
                                    return Microsoft.Office.WebExtension.initialize != undefined
                                }, function(a) {
                                    if (a) {
                                        if (i.prepareApiSurface) Microsoft.Office.WebExtension.initialize(i.getInitializationReason(b));
                                        else i.prepareRightBeforeWebExtensionInitialize(b);
                                        i.prepareRightAfterWebExtensionInitialize && i.prepareRightAfterWebExtensionInitialize()
                                    } else throw "Office.js has not been fully loaded yet. Please try again later or make sure to add your initialization code on the Office.initialize function."
                                }, 400, 50);
                                r(s(b.get_appName()))
                            };
                            !g.isScriptLoading(OSF.ConstantNames.OfficeStringsId) && x(b.get_appUILocale());
                            g.waitForScripts([OSF.ConstantNames.OfficeStringsId], function() {
                                if (n && !Strings.OfficeOM) Strings.OfficeOM = n;
                                i.loadAppSpecificScriptAndCreateOM(b, d, k)
                            })
                        });
                        if (a.isO15) {
                            var m = OSF.OUtil.parseXdmInfo() == e;
                            if (m) {
                                var f = b;
                                if (window.external && typeof window.external.GetContext !== c) try {
                        ...
                        var h = "MicrosoftAjax.js is not loaded successfully.";
                        OSF.AppTelemetry && OSF.AppTelemetry.logAppException && OSF.AppTelemetry.logAppException(h);
                        throw h
                    }
                },
                y = function() {
                    OSF.AppTelemetry && OSF.AppTelemetry.setOsfControlAppCorrelationId && OSF.AppTelemetry.setOsfControlAppCorrelationId(a.osfControlAppCorrelationId);
                    if (g.isScriptLoading(OSF.ConstantNames.MicrosoftAjaxId)) g.waitForScripts([OSF.ConstantNames.MicrosoftAjaxId], t);
                    else g.waitForFunction(m, t, 500, 100)
                };
            if (a.isO15) g.loadScript(k + OSF.ConstantNames.O15InitHelper, OSF.ConstantNames.O15MappingId, y);
            else {
                var v;
                v = a.hostType + "-" + a.hostPlatform + "-" + a.hostSpecificFileVersion + ".js";
                g.loadScript(k + v.toLowerCase(), OSF.ConstantNames.HostFileId, y)
            }
            a.hostLocale && x(a.hostLocale);
            if (C && !m()) {
                var D = (window.location.protocol.toLowerCase() === "https:" ? "https:" : "http:") + "//ajax.aspnetcdn.com/ajax/3.5/MicrosoftAjax.js";
                g.loadScriptParallel(D, OSF.ConstantNames.MicrosoftAjaxId)
            }
            ...
            var A = a.hostType == "outlook" && a.hostPlatform == "android";
            if (!A) {
    ...
    return {
        ...
        getCachedSessionSettingsKey: function() {
            return (j.conversationID != e ? j.conversationID : u) + "CachedSessionSettings"
        },
