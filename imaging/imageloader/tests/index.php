...
<a href="../../details.php?search=<?php echo $_GET['search']; ?>&response=0">
	 
        <button class="btn btn-primary" id="back">back</button></a>
    <?php } ?>

    <?php if (isset($_REQUEST['reload'])) {
	?>

<a href="../doctors/../../../doctors/lab.php?search=<?php echo $_GET['pn']; ?>&response=0">
...
<a target="_blank" href="report.php?search=<?php echo $_GET['search']; ?>&path=<?php echo $_GET['id']; ?>&req=<?php echo $_GET['req']; ?>">
