...
?>
  ...
  <div class="content-wrapper"> 
      ...
      <div class="container" id="results" > 
        <h3>served lab orders</h3><span></span></br>
        <form action="served_lab.php" method="GET">
...
<?php   $status=1;
        $result = $db->prepare("SELECT* FROM lab_orders WHERE (date >= :a AND date <=:b) AND dispensed=:c GROUP BY patient");
...
<td><?php echo $b; ?></td>
<td ><?php echo $c; ?></td>
<td><a href="details_lab.php?id=<?php echo $a; ?>"> view Details</a></td>
<?php }?>
</tr>
<tr> 
</tbody>
