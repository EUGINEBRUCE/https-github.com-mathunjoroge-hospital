...
<form action="discharge.php" method="GET">
  <span><input type="text" size="25" value="" name="search" id="country" onkeyup="suggest(this.value);" onblur="fill();" class="" autocomplete="off" placeholder="Enter patient Name" style="width: 268px; height:30px;" />
    ...
    $patient=$search;   
      ...
      <form action="savedischarge.php" method="POST">
        ...
        <textarea style="width: 100%;" name="notes"></textarea></br>
          ...
          <button class="btn btn-success" style="width: 20%;margin-left: 5%;">submit </button>
      </form>
        </div>
      </div>
         </hr>
