...
?><a href="imageloader/tests/index.php?id=<?php echo $path; ?>&search=<?php echo $search; ?>&req=<?php echo $req; ?>"><?php echo '../scans/'.$path.'- is dicom'; ?></a><?php } ?><?php if ($type==2) {	
?><a href="../doctors/view_image.php?id=../lab/imageloader/tests/data/<?php echo $path; ?>&pn=<?php echo $search; ?>&ub=1&req=<?php echo $req; ?>&imagepath=<?php echo $path; ?>"><?php echo '../scans/'.$path.'- is image'; ?></a><?php } ?></td>
