...
<body>
  ...
  <nav class="vertical_nav">
    <ul id="js-menu" class="menu">
      ...
      <li class="menu--item">
        <a href="served.php?d1=0&d2=0" class="active" title="orders served from stores">
          <i class="menu--icon  fa fa-fw fa-shopping-cart"></i>
          <span class="menu--label">served orders</span>
        </a>
      </li>
      <li class="menu--item">
        <a href="pending.php" class="menu--link" title="orders yet to served">
          <i class="menu--icon  fa fa-fw fa-shopping-cart"></i>
...
<?php   $status=1;
        $result = $db->prepare("SELECT* FROM orders WHERE date BETWEEN :a AND :b AND dispensed=:c GROUP BY patient");
