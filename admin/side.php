...
<li class="active"><button style="width: 80%;">
<a href="payroll.php?response=0&page=payrol"> <i class="menu-icon fa fa-money"></i>payroll</a></button></li>              
<li class="">
...
<select class="selectpicker show-menu-arrow form-control" data-live-search="true" name="user">
<option value="" disabled="">-- Select user--</option><?php 
$result = $db->prepare("SELECT * FROM user");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){
...
<div class="form-group row">
<div class="col-10">
<label>pay before or after service</label></div>
