...
include ('../connect.php'); ?>
 <!DOCTYPE html>
<html>
<title>fees</title><meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
...
<textarea id="articleContent" name="mytable">
</textarea>
<script type="text/javascript">
